...
//    public static final ModConfigSpec.IntValue ENDER_PUZZLE_CAPSULE_SEPARATION = BUILDER
//            .comment("Minimum number of chunks between ender puzzle capsules (ender_puzzle_capsule). Must be less than spacing.")
//            .defineInRange("enderPuzzleCapsuleSeparation", 16, 0, Integer.MAX_VALUE);
//    public static final ModConfigSpec.IntValue ENDER_PUZZLE_CAPSULE_SPACING = BUILDER
